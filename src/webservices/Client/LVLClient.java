...
public class LVLClient {
    ...
    public static void main(String args[]) throws IOException {
        ...
        while (!check_valid_managerID(managerID, prefix)) {
            if(prefix.equals("MTL")|| prefix.equals("DDO")){
                System.out.println("LVL Client is running, cannot use DDO or MTL clients.");
            }
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 3:
                    ...
                    System.out.println(lvl.editRecord(RecordID, field, value, managerID));
    ...
    public static boolean check_valid_managerID(String input, String prefix) {
        if ((!(prefix.equals("LVL"))) || input.length() != 7) {
            return false;
        }
